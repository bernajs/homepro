    ...
    cotizar: function() {
        ...
        if (flag == 0) {
            ...
            swal({
                ...
                confirmButtonText: "Aceptar",
                confirmButtonColor: "#2C8BEB"
            }, function(isConfirm) { if (isConfirm) { location.href = "cotizacion.html?servicio=" + id_servicio; } });
        ...
        Service.execute("_ctrl/ctrl.service.php", {
            ...
            function(r) {
                if (r.status == 202) {
                    ...
                    if (llamadas && cotizaciones) { historial = cotizaciones.concat(llamadas); } else if (cotizaciones) {
        ...
        Service.execute("_ctrl/ctrl.service.php", {
            ...
            function(r) {
                if (r.status == 202) {
                    ...
                    fecha_atn = fecha_atn.getDate() + '/' + (meses[fecha_atn.getMonth()]) + '/' + fecha_atn.getFullYear();
