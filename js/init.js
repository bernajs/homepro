    ...
    loginAdmin: function() {
        ...
        if (flag == 0) {
            $.ajax({
                url: "../_ctrl/ctrl.service.php",
                dataType: 'json',
                data: { exec: "loginAdmin", data: data },
                type: "POST",
                success: function(r) {
                    switch (r.status) {
                        case 202:
                ...
                switch (r.status) {
                    case 202:
                        swal({
                            ...
                            confirmButtonText: "Aceptar",
                            confirmButtonColor: "#2C8BEB"
                        }, function(isConfirm) { isConfirm ? location.href = 'index.html' : 0; });
                        break;
                    case 404:
                        swal({
                            title: "Error!",
